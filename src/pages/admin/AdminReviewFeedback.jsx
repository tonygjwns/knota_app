  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">강사가 보정한 채점 결과 — AI 채점 품질 모니터링용</p>
      </div>

      {items.length === 0 && (
        <p className="text-sm text-muted-foreground text-center py-12">검토 완료된 attempt가 없어요</p>
      )}
