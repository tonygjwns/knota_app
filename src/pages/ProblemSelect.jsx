...
import { Shuffle, BookOpen, Wrench, AlertCircle, ChevronRight, ArrowLeft } from 'lucide-react';
    ...
    <AppLayout>
      <div className="space-y-5">
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="icon" onClick={() => navigate('/')} className="btn-touch">
